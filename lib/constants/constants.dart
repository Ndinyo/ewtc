...
final TextStyle colorizeTextStyleD = GoogleFonts.merriweather(fontSize: 30);
final TextStyle colorizeTextStyleM = GoogleFonts.merriweather(fontSize: 20);
...
const String writing =
    'As seasoned professional writers we have expertise in Essay writing, Research paper witing, Thesis/Dissertation, Research proposal, Literature review, Lab report and Annotated bibliography.';
...
const String weEmploy =
    'We employ the following; formal and unbiased, clear and precise language, focused and well-structured text, well-sourced, correct and consistent methodologies in our writing.';
